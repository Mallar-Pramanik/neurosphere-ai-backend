...
class Settings(BaseSettings):
    ...
    ODYSSEUS_TEMPERATURE: float = float(os.getenv("ODYSSEUS_TEMPERATURE", "0.7"))
    ...
    # Feature Flags
    ENABLE_ODYSSEUS_AI: bool = os.getenv("ENABLE_ODYSSEUS_AI", "True").lower() == "true"
    ENABLE_GOOGLE_APIS: bool = os.getenv("ENABLE_GOOGLE_APIS", "True").lower() == "true"
